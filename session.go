...
// https://github.com/scylladb/gocql/v2/issues/612
...
var (
	...
	ErrUseStmt              = errors.New("use statements aren't supported. Please see https://github.com/scylladb/gocql/v2 for explanation.")
