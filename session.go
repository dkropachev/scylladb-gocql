...
// https://github.com/dkropachev/gocql/v2/issues/612
...
var (
	...
	ErrUseStmt              = errors.New("use statements aren't supported. Please see https://github.com/dkropachev/gocql/v2 for explanation.")
